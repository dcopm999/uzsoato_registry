# Generated by Django 3.1 on 2021-04-15 13:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='district',
            name='name',
            field=models.CharField(max_length=100, unique=True, verbose_name='Region district name'),
        ),
        migrations.AlterField(
            model_name='district',
            name='name_cyr',
            field=models.CharField(max_length=100, unique=True, verbose_name='Region district name cyrillic'),
        ),
        migrations.AlterField(
            model_name='district',
            name='name_eng',
            field=models.CharField(blank=True, default='', max_length=100, verbose_name='Region district name english'),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='district',
            name='name_rus',
            field=models.CharField(max_length=100, unique=True, verbose_name='Region district name russian'),
        ),
        migrations.AlterField(
            model_name='region',
            name='name',
